...
function doAfterAction(action,data,$selector,$after_selector){
	...
	if(action == "remove-popup-and-bg-update-graph"){
        ...
        var toatl_monthly_other_expense = data['toatl_monthly_other_expense'];
        ...
        var date = data['date'];
        var year = data['year'];
        var distributor_dashboard_url = data['distributor_dashboard_url']
        ...
        $("#id_total_sales_amount").html(total_sales_amount);
        ...
        $("#id_total_bank_amount").html(total_bank_amount);
        $("#id_total_cash_amount").html(total_cash_amount);
        $("#id_total_distributor_cash_amount").html(total_distributor_cash_amount);
        $("#id_total_distributor_bank_amount").html(total_distributor_bank_amount);
        ...
        $("#id_toatl_monthly_other_expense").html(toatl_monthly_other_expense);

        var filter_url = distributor_dashboard_url +"?period=" +period +"|default:''&year=" +year +"|default:''}}&month=" +month +"|default:''}}&from_date=" +from_date +"|default:''}}&to_date=" +to_date +"|default:''}}&date=" +date +"|default:''}}"
        $('#filter_url').attr("href", filter_url)
        var lineData = {
	        labels: date_list,
	        datasets: [
	            {
